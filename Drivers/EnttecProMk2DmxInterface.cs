...
{
    public class EnttecProMk2DmxInterface : SerialDmxDriverBase
    {
        public int UniversePort { get; set; } = 1;

        public override string DriverName => $"Enttec Pro Mk2 (Port {UniversePort})";
        ...
        public override string TxThreadName => "EnttecProMk2TxThread";

        protected override void TxLoop()
        {
            byte[] localBuffer = new byte[518];
            localBuffer[0] = 0x7E;
            localBuffer[1] = (byte)(UniversePort == 2 ? 134 : 6);
