...
{
    public class EnttecProDmxInterface : SerialDmxDriverBase
    {
        public override string DriverName => "Enttec Pro";
        ...
        public override string TxThreadName => "EnttecProTxThread";
